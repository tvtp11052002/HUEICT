...
"""Mô hình Random Forest có kết quả tốt hơn một chút nhưng có vẻ như nó đang bị "underfitting" (không khớp đúng với dữ liệu). Nên chúng ta sẽ sử dụng GradientBoosting.
